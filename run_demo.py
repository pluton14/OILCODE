...
# Проверяем ДО импорта-тяжеловесов и до первого чтения файла: без неё первый
# запуск на чужой машине падает трейсбеком pandas в глубине loaders.py,
# и непонятно, что вообще случилось.
...
SCENARIOS = {
    ...
    # замену или регенерацию катализатора. Подробности в HT_TAGS.md.
