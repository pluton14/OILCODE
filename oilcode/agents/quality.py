...
class QualityAgent:
    ...
    def assess(self, state: ProcessState) -> QualityAssessment:
        ...
        # Поэтому риск здесь считается относительно того порога, выше которого
        # блендинг уже не сможет вытянуть смесь в спецификацию.
        limit = config.BLENDING["max_rescuable_sulfur_mg_kg"]
